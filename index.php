...
=======
		...
		<!-- End Header -->
        <!-- Start Accordion/Toggle Section -->
        <div style="margin-left:4%; margin-top:4%; margin-bottom:4%; margin-right:4%;">
		<div class="row">
                    ...
                    <div class="accordion-group">
                        ...
                        <div id="oneArea" class="accordion-body collapse">
                            <div class="accordion-inner">
                                <span class="clearfix">This android application is used for emergency alerts. </span>
...
>>>>>>> aeb8fb6887d3c5c42f90f0032eb97309211718b8
					</div>
					<!-- End Blockquote -->
                    <!-- Start Blockquote -->
					<div class="span3">
